...
values
    (4, "The char on my steak was as black as my soul. Can't recommend this place enough!", 3, 3),
    (5, "I like the water that was yellow and bubbly. Ive never had Coors b4!", 1, 4),
    (1, "Never in my (very long) life have I had such a bad meal. I don't know where the chef studied, but the cuisine has a hallmark 'Durmstang' flavor to it. Blech!", 4, 2),
